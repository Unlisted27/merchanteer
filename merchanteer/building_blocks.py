...
def gen_world() -> components.Game:
    ...
    #ships
    theSliver = components.Ship("the Sliver",ketch,event_list,game,crew=[components.gen_crewmate(crew_roles,game,True),components.gen_crewmate(crew_roles,game,True)])
    theSplinter = components.Ship("the Splinter",ketch,event_list,game,crew=[components.gen_crewmate(crew_roles,game,True),components.gen_crewmate(crew_roles,game,True)])
    #Fleet
