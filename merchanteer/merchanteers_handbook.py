...
book_data = {
    ...
    "pages":[
        ...
        },
        {
            ...
            f"At the start of a new day, the player will recieve a breakdown made up of {style.YELLOW}notices{style.RESET}, of what happened during the time progression, such as if any {style.MAGENTA}contracts{style.RESET} were completed. {style.YELLOW}Notices{style.RESET} can be seen in {style.YELLOW}Game menu -> General actions -> View notices{style.RESET}.\n"
        },
        {
            "title":f"{style.UNDERLINE}Game loop{style.RESET}",
            "content":f"The basic game loop runs like this:\n"
            f"1. Go to the {style.MAGENTA}Bargain House{style.RESET} and accept a {style.MAGENTA}contract{style.RESET}.\n"
            ...
            f"4. Select {style.YELLOW}Plan voyage{style.RESET} and the {style.MAGENTA}contract{style.RESET} coresponding with the {style.GREEN}goods{style.RESET} you loaded. Then add the corresponding {style.LIGHT_BLUE}destination{style.RESET}.\n"
            ...
            f"6. You can do steps 1 through 5 as many times as you like with multiple {style.CYAN}ships{style.RESET}. You can also dispatch {style.CYAN}ships{style.RESET} to multiple destinations with multiple {style.MAGENTA}contracts{style.RESET}.\n"
            "(This continues on the next page...)"
        },
        {
            "title":f"{style.UNDERLINE}Game loop continued...{style.RESET}",
            "content":
            f"7. Progress to the next day from the main menu until you receive a notice that your {style.MAGENTA}contract(s){style.RESET} can be redeemed.\n"
            f"8. Go to the {style.MAGENTA}Bargain House{style.RESET} and redeem your {style.MAGENTA}contract(s){style.RESET}. The {style.GREEN}reward{style.RESET} will be deposited in a warehouse of your choosing\n\n"
        ...
        {
            "title":f"{style.MAGENTA}{style.BOLD}{style.UNDERLINE}Contracts{style.RESET}",
            "content":f"{style.MAGENTA}Contracts{style.RESET} are the primary money maker in Merchanteer.\n"
            f"A {style.MAGENTA}contract{style.RESET} consists of the following {style.YELLOW}important properties{style.RESET}:\n"
            ...
            f"{style.BOLD}{style.LIGHT_BLUE}Destination{style.RESET}: The destination for the {style.MAGENTA}contract{style.RESET} {style.GREEN}goods{style.RESET} to be delivered to.\n"
            f"{style.BOLD}{style.YELLOW}Status{style.RESET}: The current status of the {style.MAGENTA}contract{style.RESET}, indicating a due date, completed, or expired.\n",
            "chapter_marker":True
        },
        {
            "title":f"{style.MAGENTA}{style.UNDERLINE}Contracts{style.RESET}{style.UNDERLINE} continued...{style.RESET}",
            "content":f"{style.MAGENTA}Contracts{style.RESET} can be found in the {style.MAGENTA}Bargain House{style.RESET}. Once a {style.MAGENTA}contract{style.RESET} is accepted, the {style.GREEN}goods{style.RESET} required to be delivered will be transported to a warehouse of your choosing. The {style.GREEN}goods{style.RESET} can then be loaded onto a {style.CYAN}ship{style.RESET}, and transported to their destination. The {style.GREEN}reward{style.RESET} for the {style.MAGENTA}contract{style.RESET} will not be deposited instantly, but rather you will have to wait a small amount of time for a carrier pigeon to fly from the {style.BLUE}destination port{style.RESET} to deliver the news that the {style.GREEN}goods{style.RESET} were delivered successfully. Once a {style.MAGENTA}contract{style.RESET} is ready to be redeemed, a notice will appear at the start of a new day and you can go to the {style.MAGENTA}Bargain House{style.RESET} to redeem it."
        },
        {
            ...
            f"{style.MAGENTA}Exchanges{style.RESET} and {style.MAGENTA}Contracts{style.RESET} are in {style.MAGENTA}Magenta{style.RESET}\n"
